      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 bg-white p-6 rounded-2xl border border-neutral-100 shadow-sm">
          ...
          <div className="text-right">
            ...
            <p
              className={`text-4xl font-black ${Number(conta.saldo_atual) >= 0 ? "text-neutral-900" : "text-red-600"}`}
            >
      ...
      <div className="bg-white p-6 rounded-2xl border border-neutral-100 shadow-sm mb-6 flex flex-col md:flex-row justify-end gap-8 text-sm">
        <div className="flex items-center gap-3 text-green-600 font-bold">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-lg">{formatCurrency(totalEntradas)}</span>
          </div>
        </div>
        <div className="flex items-center gap-3 text-red-600 font-bold">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-lg">{formatCurrency(totalSaidas)}</span>
          </div>
        </div>
            ...
            {filteredMovimentacoes.length === 0 ? (
              ...
              filteredMovimentacoes.map((mov) => (
                <tr
                  ...
                  className="hover:bg-neutral-25 transition-colors group"
                >
                  <td className="p-4">
                    <div className="flex flex-col">
                  ...
                  <td className="p-4">
                    <span
                      className={`text-xs font-black uppercase ${!mov.paymentMethod || mov.paymentMethod === "MANUAL" ? "text-neutral-400" : "text-blue-600"}`}
                    >
                      {mov.paymentMethod || "---"}
                    </span>
                  </td>
                  ...
                  <td
                    className={`p-4 text-right font-black text-sm ${mov.tipo_movimentacao === "ENTRADA" ? "text-green-600" : "text-red-600"}`}
                  >
