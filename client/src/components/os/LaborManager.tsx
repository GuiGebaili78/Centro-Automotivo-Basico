...
export const LaborManager: React.FC<LaborManagerProps> = ({
  ...
  return (
    <div className="space-y-4">
      {statusMsg.text && (
        <div
          className={`text-sm font-bold p-3 rounded-lg text-center ${statusMsg.type === "error" ? "bg-red-50 text-red-600" : "bg-green-50 text-green-600"}`}
        >
          {statusMsg.text}
        </div>
      )}
                ...
                >
                  ...
                  <td className="py-3 text-center">
                    {svc.categoria === "ELETRICA" ? (
                      ...
                      <span className="text-xs font-bold bg-blue-100 text-blue-700 px-2 py-1 rounded-md uppercase tracking-wide border border-blue-200">
                        Mecânica
                      </span>
                    )}
                  </td>
