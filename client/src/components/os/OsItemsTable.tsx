    ...
    <Card className="p-0 overflow-hidden">
      <table className="tabela-limpa w-full">
        ...
        <tbody className="divide-y divide-neutral-50">
                  ...
                  <div className="text-base text-gray-900 flex flex-wrap items-center gap-2">
                    ...
                    {item.pagamentos_peca &&
                      ...
                      item.pagamentos_peca.some(
                        ...
                        <span className="px-1.5 py-0.5 rounded text-sm font-black uppercase bg-green-100 text-green-700 tracking-wider border border-green-200">
                          PAGO
                        </span>
                      )}
                    {/* STATUS ESTOQUE */}
                    {item.id_pecas_estoque && (
                      <span className="px-1.5 py-0.5 rounded text-sm font-black uppercase bg-blue-100 text-blue-700 tracking-wider border border-blue-200">
                        ESTOQUE
                      </span>
                    )}
                  </div>
                  ...
                  {!isLocked && (
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      item.pagamentos_peca.some(
                        ...
                        <span className="text-sm font-black text-neutral-400 uppercase flex items-center gap-1">
          ...
          {items.filter((item) => !item.is_interno).length === 0 && (
            <tr>
              <td
                colSpan={6}
