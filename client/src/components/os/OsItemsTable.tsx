        ...
        <tbody className="divide-y divide-neutral-50">
          {items.map((item) => (
            ...
            >
                ...
                <div className="text-base text-gray-900 flex flex-wrap items-center gap-2">
                  ...
                  {item.pagamentos_peca &&
                    ...
                    item.pagamentos_peca.some(
                      ...
                      <span className="px-1.5 py-0.5 rounded text-[11px] font-black uppercase bg-green-100 text-green-700 tracking-wider border border-green-200">
                        PAGO
                      </span>
                    )}
                  {/* STATUS ESTOQUE */}
                  {item.id_pecas_estoque && (
                    <span className="px-1.5 py-0.5 rounded text-[11px] font-black uppercase bg-blue-100 text-blue-700 tracking-wider border border-blue-200">
                      ESTOQUE
                    </span>
                  )}
                </div>
              ...
              <td className="py-3">
                <div className="text-[11px] text-neutral-400 font-black font-mono px-2 py-0.5 rounded-md w-fit">
                ...
                {!isLocked && (
                  <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    item.pagamentos_peca.some(
                      ...
                      <span className="text-[11px] font-black text-neutral-400 uppercase flex items-center gap-1">
          ...
          {items.length === 0 && (
            <tr>
              <td
                colSpan={6}
                className="p-8 text-center text-neutral-300 text-sm italic"
              >
