...
export const OsItemForm = ({
  ...
  return (
    <div className="p-4 rounded-2xl border border-neutral-200 bg-neutral-50 shadow-sm relative">
      <h4 className="text-sm font-medium text-gray-600 uppercase tracking-widest mb-3 flex items-center gap-2">
        <Package size={16} /> Adicionar Item / Buscar
      </h4>
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="relative group/search">
          ...
          <input
            ref={partInputRef}
            className="w-full p-2.5 rounded-xl border border-neutral-200 bg-neutral-25 text-base text-gray-900 outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition-all placeholder:text-gray-400"
        ...
        <div className="grid grid-cols-12 gap-3 items-end">
          ...
          <div className="col-span-2">
            <label className="text-sm font-medium text-gray-600 block mb-1 text-center">
              Qtd
            </label>
            <input
