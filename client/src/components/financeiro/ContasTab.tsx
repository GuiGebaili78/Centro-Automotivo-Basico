    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {accounts.map((acc) => (
          <div
            key={acc.id_conta}
            className={`bg-white p-6 rounded-2xl border ${acc.ativo ? "border-neutral-200" : "border-neutral-100 opacity-60"} shadow-sm relative overflow-hidden group hover:border-blue-200 transition-all`}
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="p-2 hover:bg-neutral-100 rounded-lg text-neutral-500 hover:text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <Edit2 size={16} />
                </button>
                <button
                  onClick={() => toggleDelete(acc)}
                  className="p-2 hover:bg-neutral-100 rounded-lg text-neutral-500 hover:text-red-600 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <Trash2 size={16} />
                </button>
              </div>
        ...
        <button
          onClick={handleOpenCreate}
          className="border-2 border-dashed border-neutral-200 rounded-2xl p-6 flex flex-col items-center justify-center gap-4 text-neutral-400 hover:border-neutral-300 hover:bg-neutral-50 transition-all min-h-[250px] group"
        >
