...
veiculoRoutes.get('/buscar-marcas', controller.buscarMarcas);
veiculoRoutes.get('/buscar-modelos', controller.buscarModelos);
veiculoRoutes.get('/buscar-cores', controller.buscarCores);
